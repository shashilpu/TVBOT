...
namespace TVBot.SqlServer.Entities
{
    public class TradeExecutionConfiguration : IEntityTypeConfiguration<TradeExecution>
    {
        public void Configure(EntityTypeBuilder<TradeExecution> builder)
        {
            ...
            builder.Property(x => x.ExecutionPrice).IsRequired().HasPrecision(9, 5).HasColumnOrder(3);
            builder.Property(x => x.Quantity).HasPrecision(9, 5).IsRequired().HasColumnOrder(4);
            builder.Property(x => x.TrargetPrice).IsRequired().HasPrecision(9, 5).HasColumnOrder(5);
            builder.Property(x => x.InTrade).IsRequired().HasColumnOrder(14);
            builder.Property(x => x.TradeType).IsRequired().HasColumnOrder(15);
            builder.Property(x => x.TargetPercentGain).IsRequired().HasPrecision(9, 5).HasColumnOrder(16);
            ...
            builder.Property(x => x.ExecutionFee).HasPrecision(9, 5).HasColumnOrder(19);
            ...
            builder.Property(x => x.CurrentPrice).HasPrecision(9, 5).HasColumnOrder(6);
            builder.Property(x => x.InvestedAmount).HasPrecision(15, 5).HasColumnOrder(7);
            builder.Property(x => x.CurrentProfitLossOnTrade).HasPrecision(9, 5).HasColumnOrder(8);
            builder.Property(x => x.TradeClosePrice).HasPrecision(9, 5).HasColumnOrder(9);
            builder.Property(x => x.ProfitLoss).HasPrecision(9, 5).HasColumnOrder(10);
            builder.Property(x => x.PercentProfitLoss).HasPrecision(9, 5).HasColumnOrder(11);
