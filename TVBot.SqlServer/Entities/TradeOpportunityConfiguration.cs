...
namespace TVBot.SqlServer.Entities
{
    public class TradeOpportunityConfiguration : IEntityTypeConfiguration<TradeOpportunity>
    {
        public void Configure(EntityTypeBuilder<TradeOpportunity> builder)
        {
            ...
            builder.Property(e => e.PercentChange).IsRequired().HasPrecision(3).HasColumnOrder(4);
            builder.Property(e => e.Price).IsRequired().HasPrecision(3).HasColumnOrder(3);
            builder.Property(e => e.AnalystRating).IsRequired().HasColumnOrder(5);
            builder.Property(e => e.BetaOneYear).IsRequired().HasColumnOrder(8);
            builder.Property(e => e.PercentVolalityOneWeek).IsRequired().HasColumnOrder(11);
            builder.Property(e => e.AlgoName).IsRequired().HasColumnOrder(6);
            builder.Property(e => e.Volume).IsRequired().HasPrecision(5,2).HasColumnOrder(7);
